...
def init_parser():
    ...
    # Setting
    parser.add_argument('--config', '-c', type=str, default='', help='Name of the using config', required=True)
    ...
    parser.add_argument('--use_pretrained', '-pre', default=False, action='store_true', help='Use pretrained model')
    ...
    parser.add_argument('--score', '-sc', default=False, action='store_true', help='Generate score')
